...
- **Personal Identification Information:** Name, email address, and profile picture.
- **Astrological Data:** Birth date, time, and location provided for chart generation.
- **Consultation Data:** Information shared during sessions or stored in Guest Profiles.

## 2. How We Use Your Information
We use the collected data to:
- Provide and maintain our service.
- Generate accurate astrological charts and insights.
- Faciliate communication between Students and Consultants.
- Improve our AI models and user experience.

## 3. Data Protection for Astrologers
Astrologers are solely responsible for the data of the **Guest Profiles** they create. We provide a secure environment for this data, but we do not use or analyze guest data for marketing purposes.
...
- Update your information at any time via your account settings.
