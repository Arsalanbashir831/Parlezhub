...
import { Plus, Search, Filter, Eye, Edit3, Trash2, Briefcase } from "lucide-react";
...
import { getServiceTypeLabel, getServiceStatusColor } from "@/lib/service-utils";
				...
				<CardContent>
					<div className="flex flex-col sm:flex-row gap-4">
						...
						<Select
							...
							onValueChange={(value) => setFilters({ type: value === "all" ? undefined : value as ServiceType })}
						>
						...
						<Select
							...
							onValueChange={(value) => setFilters({ status: value === "all" ? undefined : value as ServiceStatus })}
						>
							<SelectTrigger className="w-full sm:w-48">
