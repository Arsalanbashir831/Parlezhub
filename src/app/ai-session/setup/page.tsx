...
function SessionSetupContent() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-start bg-gradient-to-br from-primary-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <AiSessionHeader
      ...
      >
        <div className="flex justify-center">
          <div className="text-center">
            <h1 className="text-sm font-bold text-gray-900 dark:text-white sm:text-base md:text-xl">
