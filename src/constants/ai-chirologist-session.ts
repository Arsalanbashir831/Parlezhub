import { HandMetal, User, Focus, Play } from "lucide-react";
import { SetupStep } from "@/types/ai-session";

// Palm types for chirologist sessions
export const PALM_TYPES = [
	{ value: "dominant", label: "Dominant Hand", description: "Your primary writing hand" },
	{ value: "non-dominant", label: "Non-Dominant Hand", description: "Your secondary hand" },
...
export const CHIROLOGIST_EXPERIENCE = [
	{ value: "first-time", label: "First Time", description: "Never had a palm reading" },
	{ value: "curious", label: "Curious", description: "Some interest in palmistry" },
	{ value: "experienced", label: "Experienced", description: "Had readings before" },
];
