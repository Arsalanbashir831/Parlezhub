  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative col-span-1 overflow-hidden rounded-[24px] border border-slate-200/60 bg-white/40 p-6 shadow-sm backdrop-blur-md md:rounded-[2rem] md:p-8 xl:col-span-2"
      >
