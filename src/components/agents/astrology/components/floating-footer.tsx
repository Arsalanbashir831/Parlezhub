...
export function FloatingFooter({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 z-[100] flex -translate-x-1/2 items-center gap-2 rounded-full border border-white/20 bg-black/90 p-2 shadow-2xl xl:hidden">
