...
export default function SessionTimer({ timeRemaining }: SessionTimerProps) {
  return (
    <div className="flex items-center gap-2 md:gap-6">
      {/* Timer */}
      <div className="flex items-center gap-2 rounded-full border border-black/5 bg-black/5 px-2 py-1 backdrop-blur-sm dark:border-white/20 dark:bg-white/10 md:px-4 md:py-2">
