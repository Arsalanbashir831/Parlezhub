  ...
  return (
    <div className="mx-auto mt-20 max-w-5xl px-6 text-center duration-1000 animate-in fade-in slide-in-from-bottom-8">
      ...
      <div className="grid grid-cols-1 gap-6 text-sm md:grid-cols-3">
        <div className="group flex flex-col items-center rounded-3xl border border-primary-500/10 bg-white/[0.03] p-8 transition-[background-color,border-color] duration-300 hover:border-primary-500/30 hover:bg-white/[0.08]">
